...
processor = MatrixProcessing(top_words=3000, skip_top_words=20, skip_least_frequent=10)
...
top_word_indices,_ = processor.calculate_information_gain(binary_vectors_train, y_train, top_k=100)

print(f"Top word indices: {top_word_indices}")
